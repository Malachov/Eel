...
Do not use this library directly. Use mypythontools.pyvueeel instead.

You can find working example on https://github.com/Malachov/mypythontools/tree/master/content/python-starter
